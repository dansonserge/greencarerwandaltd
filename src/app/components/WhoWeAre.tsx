  ...
  return (
    <div className="flex items-center m-20">
      <div className="w-1/2 flex flex-col gap-10">
        <div className="gradient-accent-color font-bold text-4xl">Who We are</div>
        <div className="font-[400] text-[#272727] text-xl">
          <span className="font-bold">Greencare Rwanda Ltd </span>is a waste solutions company converting landfill
